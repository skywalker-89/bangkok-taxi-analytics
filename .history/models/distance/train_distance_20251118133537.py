...
def train():
    ...
    # --- START OF FIX ---
    # We must encode string columns like 'h3_start' into numbers
    print("Encoding categorical features...")
    # Assuming 'h3_start' is your text column like in the other script
    # If there are other text columns, encode them here too
    ...
    # This must be done *after* the train/test split
    if "h3_start_encoded" in X_train.columns:
