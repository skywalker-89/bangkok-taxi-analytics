...
def prepare_inter_zone_data():
    ...
    try:
        ...
        empty_trips = pd.DataFrame(
            {
                "vehicle_id": empty_trips["vehicle_id"],
                "trip_id": empty_trips["trip_id"],
                "start_time": empty_trips["prev_dropoff_time"],
                "start_lat": empty_trips["prev_end_lat"],
                "start_lon": empty_trips["prev_end_lon"],
                "end_time": empty_trips["pickup_time"],
                "end_lat": empty_trips["start_lat"],
                "end_lon": empty_trips["start_lon"],
            }
        )
        ...
        print("✂️ separating features (X) and target (y)...")
