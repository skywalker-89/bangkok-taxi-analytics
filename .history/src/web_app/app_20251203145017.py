...
class BangkokTaxiOptimizer:
    ...
    def __init__(self):
        ...
        try:
            # We load ALL models now to make realistic predictions
        ...
        try:
            ...
            # This is much safer than searching experiments
            ...
            # We don't raise here to allow the app to start (it will just fail gracefully on predict)
